...
3. Update project dependencies deliberately, with compatibility and security
   review rather than indiscriminate version bumps.
4. Maintain a high Rust engineering standard comparable to the Sysarmor
   ...
   complexity.
5. Improve IPv4/IPv6 candidate selection and direct-connectivity diagnostics.
6. Add secret-safe structured logging for NAT mapping and packet forwarding.
7. Make protocol-affecting changes incremental, reversible, and well tested.
8. Document the repository well and make it easy to work on safely with AI:
